"use client";
export function HomeCabinet({mode,setMode,busy,active,play,challenge,watch}:{mode:number;setMode:(n:number)=>void;busy:boolean;active:boolean;play:()=>void;challenge:()=>void;watch:()=>void}){
