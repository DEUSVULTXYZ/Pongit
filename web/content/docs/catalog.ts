...
export const catalog:DocEntry[]=[
 ...
 ].map(page=>["getting-started/welcome","playing/rooms","betting/payments","technical/architecture","technical/operations","technical/contracts","technical/api"].includes(page.slug)?{...page,updated:"2026-09-11"}:["technical/physics","technical/api","technical/operations"].includes(page.slug)?{...page,updated:"2026-09-09"}:reviewed.has(page.slug)?{...page,updated:"2026-09-08"}:page);
