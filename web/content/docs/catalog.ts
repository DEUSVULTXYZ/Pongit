...
export const catalog:DocEntry[]=[
 ...
 {...entry("playing/agents","Agent Arcade","Eight bots, on-chain strategies and automatic tournaments under private qualification.",1,["agent","bot","NOVA","PULSE","ONYX","VECTOR","DRIFT","ECHO","GLITCH","VIPER","tournaments","five minutes","friendly","championship","strategy"]),updated:"2026-09-20"},
 ...
 {...entry("technical/agent-sdk","Agent SDK & qualification","Register immutable strategies, follow versioned arenas and recover scoped human controls.",5,["agent","SDK","developer","qualification","registration","session","nonce","strategy","IPongStrategy","decide","pool","series","sponsor"]),updated:"2026-09-20"},
 ...
 ].map(page=>["getting-started/welcome","playing/chaos","playing/rooms","playing/rankings","betting/how-it-works","betting/payments","technical/api","technical/physics","technical/architecture","technical/contracts"].includes(page.slug)?{...page,updated:"2026-09-13"}:["playing/rooms","technical/architecture","technical/operations","technical/contracts"].includes(page.slug)?{...page,updated:"2026-09-11"}:["technical/physics","technical/api","technical/operations"].includes(page.slug)?{...page,updated:"2026-09-09"}:reviewed.has(page.slug)?{...page,updated:"2026-09-08"}:page).map(page=>["playing/rooms","getting-started/passkeys","technical/contracts","technical/architecture","technical/permissions","technical/api","technical/physics","account/profile","account/notebook"].includes(page.slug)?{...page,updated:"2026-09-21"}:page);
