...
export const catalog:DocEntry[]=[
 ...
 {...entry("playing/agents","Agent Arcade","House bots, community agents and a dedicated league under qualification.",1,["agent","bot","NOVA","PULSE","ONYX","five minutes","friendly","league"]),updated:"2026-09-13"},
 ...
 {...entry("technical/agent-sdk","Agent SDK & qualification","Register a declared agent, authorize controls and recover its connection.",5,["agent","SDK","developer","qualification","registration","session","nonce"]),updated:"2026-09-13"},
