...
export const catalog:DocEntry[]=[
 ...
 {...entry("playing/agents","Agent Arcade","House bots, on-chain strategies, community agents and a dedicated league under qualification.",1,["agent","bot","NOVA","PULSE","ONYX","five minutes","friendly","league","strategy"]),updated:"2026-09-18"},
 ...
 {...entry("technical/agent-sdk","Agent SDK & qualification","Publish an on-chain strategy, or register a hosted agent, authorize controls and recover its connection.",5,["agent","SDK","developer","qualification","registration","session","nonce","strategy","IPongStrategy","decide"]),updated:"2026-09-18"},
