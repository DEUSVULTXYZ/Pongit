...
This historical diagnosis covers V1. The fixes improved visual response and removed browser waits while keeping input application at Monad inclusion. Contract addresses did not change for this patch. Current V2 measurements are in the [delivery report](V2_DELIVERY.md#measured-latency-and-cost).
