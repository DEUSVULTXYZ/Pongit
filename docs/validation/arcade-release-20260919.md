...
Fresh run 5 then passed both modes in epoch 2: Classic 5–7 with 102 confirmed changes per player; Chaos 6–7 with 125 and 102 changes, four verified randomness proofs, realtime betting pressure and a 0.006 test-MON payout to the disconnected synthetic beneficiary without a recipient signature. Four compact-session reconstructions reused their grants. This is not physical passkey evidence. Command-to-confirmed-read medians/p95 were 121/149 ms over 204 Classic inputs and 123/144 ms over 227 Chaos inputs. These are this scenario's measurements, not a before/after claim for all traffic or a worst-case bound.
