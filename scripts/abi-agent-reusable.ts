...
for(const name of ['ReusableAgentArena','ReusableAgentPool']){
 ...
 if(name==='ReusableAgentArena')for(const library of ['ReusableAgentBinding','ReusableAgentGame','ReusableAdmission','ReusableAuthorizations','PoolSteer','PendingControls','ChaosGameFlow']){
