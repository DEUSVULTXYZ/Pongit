...
execFileSync(process.execPath,['--input-type=module','-e',`import {createAgentClient,AgentController,agentArcadeAbi,preparePoolRegistration,preparePoolChallenge,createPoolObserver,pooledHouseBots,preparePoolFamily,observePoolFamily,loadPoolFamily,createPoolSponsor,poolOperationId} from '@pongit/agent-sdk';
...
if([preparePoolFamily,observePoolFamily,loadPoolFamily,createPoolSponsor,poolOperationId].some(v=>typeof v!=='function'))process.exit(1);
