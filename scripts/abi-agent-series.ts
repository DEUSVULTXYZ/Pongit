...
for(const name of ['AgentSeriesPool','SeriesAgentArena']){
 ...
 if(name==='SeriesAgentArena')for(const library of ['SeriesAdmission','PoolAdmission','PoolAuthorizations','PoolSteer','PendingControls','ChaosGameFlow']){
