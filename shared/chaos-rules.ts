...
export const chaosContactResolution=(rules:unknown):boolean|'complete'=>[9,10,11,12,13,14,15].includes(rules as number)?'complete':chaosResolvesEveryContact(rules);
