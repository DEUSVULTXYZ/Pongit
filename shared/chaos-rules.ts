...
/** 9 (human) and 10 (agents) resolve obstacles and effect boundaries as a batch.
 * Keep the historical 6/7/8 algorithms selectable for saved matches. */
export const chaosContactResolution=(rules:unknown):boolean|'complete'=>rules===9||rules===10?'complete':chaosResolvesEveryContact(rules);
