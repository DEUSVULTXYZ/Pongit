...
function validate(ticket:ReusableTicket,b:ReusableAgentBinding,e:ReusableAgentEvidence,cancel:boolean){
...
export const validateReusableAgentAdmission=(ticket:ReusableTicket,b:ReusableAgentBinding,e:ReusableAgentEvidence)=>validate(ticket,b,e,false);
/** Cancellation verifies the original issued ticket. Expired player permission
 * and absent strategy code must not prevent clearing an unplayed admission. */
export const validateReusableAgentCancellation=(ticket:ReusableTicket,b:ReusableAgentBinding,e:ReusableAgentEvidence)=>validate(ticket,b,e,true);
