...
export type AgentPoolManifest={
 ...
 tournaments:Address;ratings:Address;challenges:Address;family:Address;arenas:PoolArena[];
...
export function validateAgentPoolManifest(m:AgentPoolManifest,humanApps:readonly string[]=[]):AgentPoolManifest {
 ...
 const contracts=[m.hub,m.pool,m.catalog,m.tournaments,m.ratings,m.challenges,m.family];
