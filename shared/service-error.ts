...
export function publicationFailureDetails(error:unknown){
 let batch:string|undefined,relayStatus:number|undefined,hourlyCommitLimit=false;
 ...
 return {batch,relayStatus,reason:relayStatus===429?(hourlyCommitLimit?'hourly_commit_limit':'publication_rate_limit'):relayStatus===413?'payload_too_large':relayStatus===401||relayStatus===403?'relay_authentication':'publication_failed'};
}
