...
import {GameV3 as Game} from "../v3/GameV3.sol";
import {Vault} from "../Vault.sol";

contract TournamentsV4 is AccessControl, EIP712, NativePayouts {
    ...
    function advance(uint256 id) external nonReentrant {
        ...
        if (winners.length == 1) {
            ...
            t.prize = 0;
            _schedulePayout(1, id, t.winner, prize);
    ...
    function cancel(uint256 id) external nonReentrant {
        ...
        t.seedPrize = 0;
        _schedulePayout(3, id, treasury, seed);
    ...
    function refund(uint256 id, address player) external nonReentrant {
        ...
        t.prize -= t.fee;
        _schedulePayout(2, id, player, t.fee);
    }
}
